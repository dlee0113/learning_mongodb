...
// *** NOTE: this class is no longer be needed
// ***       All functionality has been folded into Members
...
class Purchases
{
	...
	// *** this file and class will then become obsolete
	// *** NOTE: although all fields are returned, only these are needed:
